...
class Gestion_apuestas extends CI_Model {

    function Gestion_apuestas() {
        parent::__construct();
...
/*
	...
	//Obtener puesto piloto - Modificado
    function getPosicionPiloto_garin($id_piloto, $idGp) {
        $sql = "SELECT * FROM resultados_pilotos_2011 WHERE id_piloto = ? AND id_gp= ?";

        $posicion = $this->db->query($sql, array($id_piloto , $idGp))->row()->posicion;
        ...
        foreach ($query as $linea) 
		{
            ...
            switch ($linea->tipo_apuesta) 
			{
                ...
                case 0:
                    ...
                    //Se obtiene la posicion del piloto
                    $posicion = $this->getPosicionPiloto_garin($linea->id_campo1 , $idGp);
                ...
                case 1:
                    ...
                    //Se obtiene la posicion del piloto 1
                    $posicionPiloto1 = $this->getPosicionPiloto_garin($linea->id_campo1 , $idGp);

                    //Se obtiene la posicion del piloto 2
                    $posicionPiloto2 = $this->getPosicionPiloto_garin($linea->id_campo2 , $idGp);
