			...
			<div class="col-md-8">
				<section class="panel">
					...
					<div class="panel-body">
						...
						<ul class="ulpilotos">
							<li>El precio de los pilotos <strong>varia a diario</strong> en
								función de las <strong>compras/ventas o inactividad</strong>
								que haya recibido el dia anterior.
							</li>
							<li>El precio de los pilotos variará despues de cada Gran Premio
								en base a sus resultados.</li>
							<li>Los <strong style="color: #60C8FF">pilotos alquilados</strong>
							...
							<li>Los <strong style="color: #77AA3B">pilotos fichados</strong>,
								formarán parte continua de tu plantilla hasta que <strong>tú</strong>
								decidás venderlos.A estos se les puede añadir cualquier tipo
								de STIKI y podrán beneficiarse de tus mejoras
							</li>
						</ul>
											...
											<table
												...
												<tbody>
													...
													<tr>
														...
														</a> <span class="team-subtit"><?php echo $piloto->getEquipo()->getEscuderia(); ?>
														</span></td>
														<td class="numeric"
															style="background-color: rgb(255, 249, 239); color: rgb(188, 164, 108);"><?php echo $piloto->getValorAnterior(true); ?>
														</td>
														<td class="numeric"><?php
														if ($piloto->getCambioValor() > 0):
														?> <i class="fa fa-angle-double-up"
															style="color: rgb(90, 157, 29); font-size: 16px;"></i> <span
															style="color: rgb(90, 157, 29);"> <?php elseif ($piloto->getCambioValor() < 0) : ?>
														...
														<td class="numeric"><a
															href="<?php echo site_url() . 'mercado/ficharPiloto/' . $piloto->getIdPiloto(); ?>"
															class="btn btn-success btn-xs confirm"> <i
																class="fa fa-shopping-cart"></i> <?php echo $piloto->getValorActual(true); ?>
														</a></td>
														<td class="numeric"
															style="background-color: rgb(253, 242, 255); color: rgb(162, 122, 170);"><?php echo $piloto->getValorMax(true); ?>
														</td>
														<td class="numeric"
															style="background-color: rgb(255, 237, 237); color: rgb(191, 120, 120);"><?php echo $piloto->getValorMin(true); ?>
														</td>
														<td class="numeric"><a
															href="<?php echo site_url() . 'mercado/alquilarPiloto/' . $piloto->getIdPiloto(); ?> "
															class="btn btn-info btn-xs confirm"><i
																class="fa fa-flag-checkered"></i> <?php echo $piloto->getPrecioAlquiler(true); ?>
														</a></td>
													</tr>
													<?php endforeach; ?>
