                                                    ...
                                                    <li style="vertical-align: middle;"><a href="javascript:;"><i class="fa fa-tachometer" style="margin-right: 4px"></i> Cambio valor : <?php if ($piloto->getCambioValor() > 0): ?>
                                                        <span class="badge label-success2 pull-right r-activity" style="margin: 0 0 0;">
                                                            ...
                                                            <?php elseif ($piloto->getCambioValor() < 0) : ?>
                                                                ...
                                                                <li style="vertical-align: middle;"><a href="javascript:;"><i class="fa fa-credit-card" style="margin-right: 4px"></i> Valor maximo : <span style="margin: 0 0 0;" class="badge  pull-right r-activity"><?php echo $piloto->getValorMax(true); ?></span></a></li>
                                                                <li style="vertical-align: middle;"><a href="javascript:;"><i class="fa fa-credit-card" style="margin-right: 4px"></i> Valor minimo : <span style="margin: 0 0 0;" class="badge  pull-right r-activity"><?php echo $piloto->getValorMin(true); ?></span></a></li>
