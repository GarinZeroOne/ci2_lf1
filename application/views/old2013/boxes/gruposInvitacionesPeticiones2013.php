...
<div class="row">
    ...
    <div class="span6">
        ...
        <div id="realizarInvitacion" >
        <div id="contenidoInvitaciones" align="center">
            <?php
    ...
    <div class="span6">
        ...
        if (count($invitacionesRecibidas) == 0) {
            ...
            foreach ($invitacionesRecibidas as $linea) {
                ...
                . "<br><a class='btn' onclick=\"doAjax('" . $sitio . "grupos/aceptaInvitacion','idInvitacion="
                . $linea->id . "','aceptaInvitacion','post',1)\">" . $this->lang->line('grupos_lbl_aceptar') . "</a>
                          -
        <a class='btn btn-danger' onclick=\"doAjax('" . $sitio . "grupos/rechazaInvitacion','idInvitacion="
...
<div class="row">
    <div class="span12">
        ...
        <h3 class="boxcab"><? echo $this->lang->line('grupos_titulo_peticiones'); ?></h3>
...
<div class="row">
    ...
    <div class="span6">
        ...
        <? echo "<div align='center'>" . $this->lang->line('grupos_txt_form_pet') . "</div>"; ?>

        <div class="cform" align="center">
            <form id="formNuevaPeticion" method="post">
                <table id ="tablaInvitaciones" class="tabla2">
                    <tr>
    ...
    if (count($listaPeticionesRecibidas) == 0) {
        ...
        foreach ($listaPeticionesRecibidas as $linea) {
            ...
            $this->lang->line('grupos_txt_pet_recibidas_otros') . $linea->nombre . "<br>
                             <a class='btn' onclick=\"doAjax('" . $sitio . "grupos/aceptaPeticion','idPeticion=" . $linea->id . "',
                                                      'aceptaPeticion','post',1)\">Aceptar</a>
                              -
                             <a class='btn btn-danger' onclick=\"doAjax('" . $sitio . "grupos/rechazaPeticion','idPeticion=" . $linea->id . "',
