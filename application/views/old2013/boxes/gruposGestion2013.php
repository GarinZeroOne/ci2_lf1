<div class="row">
    ...
    <div class="span6">
         ...
         <h3 class="boxcab"><? echo $this->lang->line('grupos_titulo_crear_grupo')?></h3>
        <div id="formularioCrear" class="formularioGestionGrupos" >
            <h4 class="gh4"><? echo $this->lang->line('grupos_txt_form_crear_grupo')?></h4>
            <form id="form_crear_grupo" method="post" action="<? echo site_url() . "grupos/nuevoGrupo" ?>">
                <table>
                    <tr>
                        <td class="nombreCampos2 inv"><? echo $this->lang->line('grupos_lbl_nombre')?></td>
                        <td class="inputCampos2">
    ...
    if (!count($gruposPropios) == 0):
        ?>
        <h3 class="boxcab"><? echo $this->lang->line('grupos_titulo_gestion_miembros')?></h3>
        ...
        <div id="gestionMiembrosGrupo" class="formularioGestionGrupos">
            <h4 class="gh4"><? echo $this->lang->line('grupos_txt_form_borrar_usuario')?></h4>
            <form id="formBorrarUsuario" method="post">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="nombreCampos2 inv">Nick</td>
                        <td class="inputCampos2">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input type="button" value="<? echo $this->lang->line('grupos_bot_borrar_usuario_grupo')?>" class="btn btn-danger"
                            <?php
            ...
            <div align="center" class="zdelg">
                <?
                echo "<a class='btn btn-danger' href=\"" . base_url() . "grupos/borrarGrupo/"
